    ...
    <div className="bg-white p-4 rounded-lg shadow-sm border border-blue-200 flex flex-col gap-4">
      ...
      {settings.ideaMode === 'paid' && (
        <div className="flex flex-col gap-4">
          ...
          {/* === KOTAK MERAH NEGATIVE CONTEXT === */}
          <div className="col-span-full">
            <label className={`${labelClass} text-red-600 font-bold`}>Negative Context (Kata Terlarang)</label>
            <textarea
              ...
              placeholder="Contoh: violence, nude, text, logo, watermark..."
